...
This repository builds upon the publicly available YOLO-World implementation and is intended solely for experimental analysis and educational purposes. Any results, observations, or discussions presented here reflect independent experimental evaluations and do not represent claims of improvement over the original work. Full credit for the original model, code, and ideas belongs to the YOLO-World authors.
```bibtex
